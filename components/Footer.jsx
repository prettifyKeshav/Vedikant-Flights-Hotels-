                ...
                <div className="main-footer container">
                    ...
                    <div className="colB">
                        <div className="list">
                            <h6>SERVICES</h6>
                            <ul>
                                <li><Link href="/">Advanced SMT PCB Assembly</Link></li>
                                <li><Link href="/">Design for Manufacturing</Link></li>
                                <li><Link href="/">Engineering and Design</Link></li>
                                <li><Link href="/">Quick Turn Assembly Services</Link></li>
                                <li><Link href="/">Mixed Technology Assembly</Link></li>
                                <li><Link href="/">Assurance of Absolute Quality</Link></li>
                                <li><Link href="/">One-Stop Source for All Services</Link></li>
                            </ul>
                        </div>
                        <div className="list">
                            <h6>QUICK LINKS</h6>
                        ...
                        <div className="list">
                            ...
                            <ul>
                                <li><a href="https://www.google.com/maps?ll=41.98127,-87.988919&z=16&t=m&hl=en-US&gl=US&mapclient=embed&q=300+Bauman+Ct+Wood+Dale,+IL+60191+USA" target="_blank">
                                    ...
                                    <span>300 BAUMAN CT, WOOD DALE, IL 60191</span>
                                </a>
                                </li>
